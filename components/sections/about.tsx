        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              "Turning complex problems into elegant, performance-driven
              solutions."
            </p>
          </motion.div>
            ...
            {[
              ...
              >
                <div className="relative z-10 flex items-center gap-4">
                  <div
                    className={`flex-shrink-0 w-11 h-11 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center shadow-lg transition-all duration-500 group-hover:scale-110 group-hover:-rotate-3`}
                  >
            ...
            >
              ...
              <div className="prose prose-neutral dark:prose-invert max-w-none">
                <p className="text-xl text-muted-foreground leading-relaxed font-light">
                  ...
                  . My focus is on creating seamless user experiences powered by
                  robust, scalable backends.
                </p>
                <p className="text-lg text-muted-foreground/70 leading-relaxed font-light">
                  With over 3 years in the industry, I've moved beyond just
                  writing code to{" "}
                  <span className="text-foreground font-semibold">
                    engineering solutions
                  </span>{" "}
                  that drive business value. Whether it's optimizing a React
                  render cycle or designing a distributed system, I bring a
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                {[
                  {
                    icon: Zap,
                    text: "Performance-First Design",
                    desc: "Optimized for speed and scale",
                  },
                  {
                    icon: Award,
                    text: "Clean Architecture",
                    desc: "Maintainable and scalable code",
                  },
                ].map((feature, i) => (
                  <div
                    key={i}
                    className="group flex flex-col gap-3 p-6 rounded-[1.5rem] bg-card/40 border border-border/40 hover:border-primary/40 transition-all duration-300"
                  >
