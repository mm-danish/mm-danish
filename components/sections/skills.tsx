...
const categoryConfig: Record<
  Skill["category"],
  { label: string; icon: any; color: string; shadow: string }
> = {
  frontend: {
    label: "Frontend",
    icon: Code2,
        ...
        <div className="max-w-6xl mx-auto">
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div className="max-w-2xl">
              ...
              >
                A high-performance toolkit for building enterprise-grade digital
                experiences.
              </motion.p>
            </div>
          </header>
                    ...
                    <Card className="h-full border-border/40 bg-card/40 backdrop-blur-xl hover:border-primary/40 transition-all duration-500 overflow-hidden relative rounded-3xl border-[1px] group">
                      <CardContent className="p-6 h-full flex flex-col relative z-20">
                        ...
                        <div className="flex items-center gap-4 mb-6">
                          <div
                            className={`p-2.5 rounded-xl bg-gradient-to-br ${config.color} ${config.shadow} shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-3`}
                          >
