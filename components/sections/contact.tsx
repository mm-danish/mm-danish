...
export function Contact() {
  return (
    <section
      id="contact"
      className="pt-24 relative overflow-hidden bg-background"
    >
            ...
            >
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-md font-light">
                  I'm currently opening for freelance opportunities or full-time
                  roles. Let's engineer the future together.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-5">
                ...
                <Link href={SOCIAL_LINKS.email} className="w-fit">
                  <Button
                    size="lg"
                    className="rounded-full h-14 px-8 text-sm shadow-xl hover:shadow-primary/20 transition-all font-bold group"
                  >
                  ...
                  >
                    <Card className="h-full border border-border/40 bg-card/40 backdrop-blur-xl hover:border-primary/40 transition-all duration-300 group rounded-[1.5rem] overflow-hidden">
                      <CardContent className="p-6 flex flex-col items-start gap-4 h-full">
                        <div
                          className={`p-3 rounded-2xl bg-gradient-to-br ${method.color} ${method.shadow} shadow-lg transition-transform duration-500 group-hover:scale-110`}
                        >
                          <Icon className="h-5 w-5 text-white" />
                        </div>

                        <div className="space-y-1 mt-auto">
                          <h3 className="font-bold font-heading text-lg tracking-tight group-hover:text-primary transition-colors">
                            {method.name}
                          </h3>
                          <p className="text-[11px] text-muted-foreground/60 truncate max-w-[140px] font-medium">
                            {method.value}
                          </p>
                        </div>
