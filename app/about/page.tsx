      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          >
            <div className="relative w-72 h-72 sm:w-80 sm:h-80">
              ...
              >
                ...
                <span className="text-[10px] font-extrabold tracking-tight text-emerald-600 dark:text-emerald-400">
                  Available
                </span>
              </motion.div>
            </div>
          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p className="text-lg font-light">
                I started my journey in software engineering with a passion for
                solving real-world problems through code. With a{" "}
                <span className="text-foreground font-semibold">
                  BS in Computer Science from FUUAST Islamabad
                </span>
                , I built a strong foundation in algorithms, data structures,
                and software design patterns.
              </p>
              <p className="text-base font-light">
                Over the past{" "}
                <span className="text-foreground font-semibold">3+ years</span>,
                I've gone beyond just writing code — I engineer solutions that
                drive business value. From optimizing React render cycles to
                designing distributed systems, I bring a meticulous approach to
                every project.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {[
            ...
            >
              <div
                className={`flex-shrink-0 w-12 h-12 rounded-2xl bg-gradient-to-br ${item.color} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500`}
              >
                <item.icon className="h-5 w-5 text-white" />
              </div>
              <div className="min-w-0">
                <span className="text-[9px] font-black uppercase tracking-[0.2em] text-primary block mb-0.5">
                  {item.label}
                </span>
                <h3 className="text-base font-black font-heading truncate">
                  {item.value}
                </h3>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {values.map((v, i) => (
              ...
              >
                <div
                  className={`flex-shrink-0 w-11 h-11 rounded-2xl bg-gradient-to-br ${v.color} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500`}
                >
                  ...
                  <CardContent className="p-6 md:p-8">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {exp.technologies.map((tech) => (
                        <span
                          key={tech}
                          className="px-2.5 py-1 rounded-lg bg-primary/5 border border-primary/10 text-[10px] font-bold uppercase tracking-tight text-muted-foreground/70"
                        >
                          {tech}
                        </span>
                      ))}
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            {interests.map((item, i) => (
              <div
                key={i}
                className="flex items-center gap-2 px-4 py-2 rounded-full border border-border/50 bg-muted/30 text-sm font-medium text-muted-foreground hover:border-primary/40 hover:text-primary transition-all"
              >
