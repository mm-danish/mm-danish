  ...
  return (
    <div className="min-h-screen bg-background pt-32 pb-24">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        <div className="absolute top-0 left-1/4 w-150 h-100 bg-primary/5 blur-[120px] rounded-full" />
        <div className="absolute bottom-0 right-1/4 w-125 h-100 bg-blue-500/5 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="mb-16 space-y-4">
          ...
          >
            A collection of production-grade applications, client work, and
            personal builds — each crafted with precision and purpose.
          </motion.p>
        </div>
        ...
        >
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-[12px] font-bold uppercase tracking-wider transition-all duration-200 border ${
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filtered.map((project, index) => (
              ...
              >
                {/* Image */}
                <div className="relative aspect-video rounded-2xl overflow-hidden border border-border/40 bg-card transition-all duration-500 group-hover:border-primary/30 group-hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] mb-5">
                  <Image
                    src={project.image}
                    alt={project.title}
                    fill
                ...
                <div className="px-1 space-y-3 flex-1 flex flex-col">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <span className="text-[10px] text-muted-foreground/40 font-mono shrink-0 mt-1">
                      {project.year}
                    </span>
                  </div>
