  ...
  return (
    <div className="min-h-screen bg-background pt-32 pb-24">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        <div className="absolute top-1/4 -left-20 w-125 h-100 bg-primary/5 blur-[120px] rounded-full" />
        <div className="absolute bottom-0 right-0 w-125 h-100 bg-blue-500/5 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="mb-20 max-w-3xl">
          ...
          >
            thoughts on building production-grade software, clean architecture,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {blogPosts.map((post, index) => (
            ...
            >
              <Link
                href={`/blog/${post.slug}`}
                className="block relative aspect-video rounded-3xl overflow-hidden border border-border/40 bg-card mb-6 "
              >
                <Image
                  src={post.image}
                  alt={post.title}
              ...
              <div className="space-y-4">
                ...
                <Link
                  href={`/blog/${post.slug}`}
                  className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-primary hover:text-primary/70 transition-colors"
                >
